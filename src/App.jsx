...
const App = () => {
    ...
    const [suggestions] = useState([
        ...
        "How is Qlik Cloud Analytics different from Qlik Sense Enterprise?",
        ...
        "Does Qlik Cloud integrate with cloud storage platforms like Amazon S3, Azure, and Google Cloud?",
        ...
        "How can administrators manage user roles and access permissions for Qlik Cloud?",
        ...
        "What is the difference between Qlik Talend Cloud and Talend Studio?",
        ...
        "What authentication and identity management options are supported for Qlik Talend Cloud?",
        ...
        "Can I switch from monthly to annual billing (or vice versa) for Qlik Cloud Analytics?",
        "How do I update my billing information or payment method?",
        "Are refunds available if I cancel my subscription early for Qlik Sense Business?",
        ...
        "How can I check the status of an existing support ticket?",
        ...
        "How should I approach creating posts on Qlik Community?",
        ...
        "How is the Qlik Support Chatbot being used to drive faster support responses?",
        "How can I effectively troubleshoot unusual script behavior or syntax errors in Qlik Sense?"
    ]);
    ...
    const sendIntentToAPI = useCallback(async (intent) => {
        try {
            const response = await fetch('https://634e959541e5.ngrok-free.app/api/chat', {
                method: 'POST',
